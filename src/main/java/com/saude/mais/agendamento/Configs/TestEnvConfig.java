...
public class TestEnvConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            AddressEntity address = new AddressEntity(faker.address().streetName(), faker.address().streetName(), faker.address().streetAddressNumber(), faker.address().city(), BrazilianStates.MINAS_GERAIS, faker.address().zipCode());
        ...
        AddressEntity addresses = new AddressEntity("Rua Maria Aparecida Peixoto", "Santa Rosa", "59", "Uberlândia", BrazilianStates.MINAS_GERAIS, "38401312");

        hospitalEntity = new HospitalEntity("Albert Einstein", "75796109000186", "www.alberteinstein.saude-mais.com.br", addresses, "3498245817", "3498245818", "albert@email.com");
